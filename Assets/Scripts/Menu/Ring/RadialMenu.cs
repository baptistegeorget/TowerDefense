...
public class RadialMenu : MonoBehaviour
{
    ...
    public void BuildTurret()
    {
            ...
            turret = (GameObject)Instantiate(TurretToBuild, node.position + positionOffset, Quaternion.Euler(new Vector3(-90, 0, 0)));
    ...
    public void Open()
    {
        ...
        {
            AddEntry(listTurret[i].price.ToString(), listTurret[i].icon, listTurret[i].prefeb, SetTargetIcon);
        }
        Rearrange();
    }
